...
Name: Michael R. Moroz

CNetID: mrmoroz

Section: 1 (1:30 - 2:50 pm, Monday and Friday)

Mini-project title: Assignment: Clean the mtcars Dataset (Level 1)

Submission date: January 31st, 2025

Project GitHub subdirectory URL:

https://github.com/mikemoroz1/d2mr-assessment-mrmoroz/tree/main/01_data-cleaning/01_cleaning-level-1 
...
1. Did you complete the project with direct collaborators or general support? If so, who did you collaborate with and what was/were their contribution(s)?
    ...
    No I did not have any direct collaborators or general support. Aziz, Aspen and I discussed which project we were supposed to start with, and all came to the conclusion to start with the project labeled #1 in the forked repository (which we later found out was not the right project to start with), but that is all. I am proud to say all of this work is my own (with the help of various Google searches to troubleshoot my code problems). All websites I used for reference are linked within each code chunk for transparency. 
...
2. Did you use LLMs or other AI models to generate text or code for this project? If so, which tools did you use and how did you use them? Remember in this class you *are* allowed (even encouraged) to use these tools for help with coding, but not for writing text. This can be very brief, just one or two sentences is fine unless you have more you'd like to add.
  ...
  I used websites like StackOverflow and DataCamp (among others) for troubleshooting when I ran into problems with my code. People go on those websites and post similar problems that they have run into, and other people respond with solutions/fixes. I used those replies as a framework to troubleshoot my code when I ran into trouble. All the links are included in my code project (that I used as references), but I did not generate text or code for this project. I do not believe in the use of those models for coursework because if I use those then there's no way for me to learn something new if I have something or someone do it for me. I think it's always better if I do it myself (even if it's not totally correct) than having perfect code do it for me without me actually having to learn how to do it. 
...
I think I did this throughout my code. There are comments in each code chunk that display my thought process as I was completing the code, and my markdown output (outside the code chunks) displays my thought process with regards to what I need to do when answering each of the prompt questions at the beginning of the cleaning mini-project. The comments throughout are clear, concise, detailed and organized. I put a lot of effort into those comments and question responses, so I think I should get credit for that here.  

2.  find and understand documentation for R packages and functions

There were multiple times throughout my code chunk when I had to figure out what a package does. I did this by using the '?' before the package name, which generated lists of different types of functions embedded within each overarching package. This allowed me to figure out which piece of code I needed from those packages would allow me to get to my desired output. I think I demonstrated that skill here. 

15. recognize and interpret common data visualizations

I believe I demonstrated this skill throughout my mini-project. I did this both in the code chunks and outside the code chunks when explaining what each graph meant, and how to interpret its results. In addition, I also interpreted common statistics used with each data visualization, so I believe I should get credit for this additional objective here. 

16. determine most appropriate visualizations and analyses for specific research questions and data

I believe I demonstrated this skill throughout my mini-project by using different types of plots (line plots, histograms, box plots, etc) when working with different kinds of data, research questions and hypotheses. I used line plots to understand the relationship between two variables, histograms to understand whether the raw data followed that of a typical normal distribution, and box plots to compare differences between groups with a resulting t-test. I think my visualizations appropriately follow my research questions and data. 
...
I'm proud of the work I did on this mini-project. I was going to stay away from this mini-project because I didn't think it would be a good project for me to work with to hit a lot of objectives, but I'm glad I troubleshooted and stayed the course. In this project, I learned that there are a bunch of different methods to clean data, and that some methods are perhaps more efficient and beneficial than others. I also built new skills by working with different functions like factor and str_replace_all, among others, that I can apply to my research project as I work toward the end of the quarter. I also gained experience making my own data sets, and manipulating said data, using the 'tidyverse' data manipulation framework. Overall, I think I did a good job demonstrating a bunch of different objectives in clean code chunks with informative comments, and I am very proud of my work on this project! Even though there was a bunch of googling (in addition to using the lecture slides and the instructional walkthroughs associated with different mini-projects), I learned a lot. 
